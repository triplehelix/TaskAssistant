...
public class TaskApiHelper {
    ...
    static ArrayList<Task> toTasks(ArrayList<String> bactickTasks) throws Exception{
        ...
        for(String s: bactickTasks) {
            ...
            task.setImportant(TaskApiHelper.parseJsonBooleanAsBoolean(taskElementArray[3]));
            ...
            task.setUrgent(TaskApiHelper.parseJsonBooleanAsBoolean(taskElementArray[7]));
            task.setDueDate(TaskApiHelper.parseJsonDateAsDate(taskElementArray[8]));

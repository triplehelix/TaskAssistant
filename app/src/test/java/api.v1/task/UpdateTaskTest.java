...
public class UpdateTaskTest extends TaskApiHelper{
    ...
    public void setUp() throws Exception {
       ...
       sampleUsers.add("1`kenlyon@gmail.com`Mouwkl87%qo");
        ...
        errorUpdates.add(  "8`0`Mike's work task A`TRUE`This task belongs to Mike H.`60000`100000`TRUE`2020-05-31T00:00:00.123Z`NEW");
        ...
        errorUpdates.add(  "2`0`Mike's home task E`TRUE`This task belongs to Mike H.`qqqqq`100000`TRUE`2020-05-31T00:00:00.123Z`NEW`[2]`[1,2]");   // Invalid invested time.
